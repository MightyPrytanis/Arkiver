...
To report a security vulnerability, please use the [Private Vulnerability Reporting](https://github.com/MightyPrytanis/Arkiver/security/advisories/new) feature on GitHub.
